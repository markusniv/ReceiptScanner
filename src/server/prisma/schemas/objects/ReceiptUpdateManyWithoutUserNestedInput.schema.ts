...
const Schema: z.ZodType<Prisma.ReceiptUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ReceiptUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => ReceiptUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ReceiptUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => ReceiptUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
